...
function App() {
    ...
    const getTeacherProfile = async () => {
        try {
            const Teacher = await axios.get(`teacher/profile/${id}`);
    ...
    const getStudentProfile = async () => {
        try {
            const StudentProfile = await axios.get(`student/profile/${id}`);
    ...
    const getPersonelProfile = async () => {
        try {
            const PersonelProfile = await axios.get(`student/profile/${id}`);
