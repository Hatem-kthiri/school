...
const AllStudents = ({ toggle }) => {
    ...
    const getTeacherClass = async () => {
        const Classes = await axios.get(`/teacher/getClass/${teacher_id}`);
    ...
    const getAllStudents = async () => {
        const Students = await axios.get("/administation/AllStudents");
    ...
    const submitAll = (e) => {
        e.preventDefault();
        axios
            .post("/teacher/addSituation", allSituation)
            .then((res) => {
