...
const Teacher = ({ toggle }) => {
    ...
    const getAllTeachers = async () => {
        const Teachers = await axios.get("/administation/AllTeachers");
    ...
    const getAllClass = async () => {
        const Classes = await axios.get("/administration/GetAllClass");
            ...
            {teachers.length > 0 ? (
                <div>
                    <div
                        ...
                        className={
                            toggle ? "teacher-view" : "teacher-view-closed"
                        }
                    >
                ...
                <div
                    className="loader-admin-teacher"
